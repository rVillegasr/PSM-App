...
public class EventCRUD extends SQLHelper{
    ...
    public static final String ADDRESS         = "category";
    ...
    *       Obtener uno o todos los eventos.
    ...
    public void createEvent(Event event){
        ...
        values.put(DATE, String.valueOf(event.getDate()));
    ...
    public List<Event> readEvents(){
        ...
        if (cursor.moveToFirst()){
            while (!cursor.isAfterLast()){
                ...
                String description  = cursor.getColumnName(cursor.getColumnIndex(DESCRIPTION));
                String imagePath    = cursor.getColumnName(cursor.getColumnIndex(IMAGE));
                String coverPath    = cursor.getColumnName(cursor.getColumnIndex(COVER));
                int price           = cursor.getInt(cursor.getColumnIndex(PRICE));
                long date           = cursor.getLong(cursor.getColumnIndex(DATE));
                String category     = cursor.getColumnName(cursor.getColumnIndex(CATEGORY));
